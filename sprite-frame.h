...
struct SpriteFrame
{
	...
	void draw(QPainter &painter, const TileManager &tile_manager, Tile::PixmapType unselected_effect, int selected_piece_index, Tile::PixmapType selected_effect, int starting_palette_line = 0, int x_offset = 0, int y_offset = 0) const;
	QRect rect() const;
